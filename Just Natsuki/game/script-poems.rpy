...
init python in jn_poems:
    ...
    _m1_script0x2dpoems__registerPoem(JNPoem(
        ...
        poem=(
            ...
            "Un árbol siempre verde libre para decoración\n"
            "Esperando ansiosamente a dos personas\n"
            "Para cubrirlo con adornos y luces.\n"
            "\n"
            "Ese árbol es una plantilla de lo que vendrá\n"
    ...
    _m1_script0x2dpoems__registerPoem(JNPoem(
        ...
        poem=(
            ...
            "Ella te dejará entrar y juntos serán libres para descartar la tristeza\n"
