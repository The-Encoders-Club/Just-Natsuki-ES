...
label holiday_easter:
    ...
    if not easter_poem.unlocked:
        ...
        call show_poem (easter_poem) from _call_show_poem
...
label holiday_halloween:
    ...
    if Natsuki.isLove(higher=True) and jn_events.getHoliday("holiday_halloween").shown_count == 0:
        ...
        $ jnPause(0.5)
        call show_poem (halloween_poem) from _call_show_poem_1
...
label holiday_christmas_day:
    ...
    if christmas_poem:
        ...
        call show_poem (christmas_poem) from _call_show_poem_2
...
label holiday_natsuki_birthday:
    ...
    if Natsuki.isEnamored(higher=True):
        ...
        if birthday_poem:
            ...
            call show_poem (birthday_poem) from _call_show_poem_3
            $ jnPause(3)
...
label holiday_player_birthday:
    ...
    if birthday_poem:
        ...
        call show_poem (birthday_poem) from _call_show_poem_4
