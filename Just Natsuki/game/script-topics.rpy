...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Did you ever have any pets?"),
            category=[_("Animals"), _("Family")],
            player_says=True,
...
init python:
    registerTopic(
        Topic(
            ...
            category=[_("Health"), _("Technology")],
            nat_says=True,
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Staying active"),
            conditional="persistent.jn_total_visit_count >= 5",
            category=[_("Life"), _("You"), _("Health")],
            nat_says=True,
            affinity_range=(jn_affinity.HAPPY, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Careful spending"),
            category=[_("Life"), _("You"), _("Health"), _("Society")],
            nat_says=True,
            affinity_range=(jn_affinity.HAPPY, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Eating well"),
            category=[_("Life"), _("You"), _("Health"), _("Food")],
            nat_says=True,
            affinity_range=(jn_affinity.HAPPY, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Setting up the weather"),
            category=[_("Setup"), _("Weather")],
            nat_says=True,
            affinity_range=(jn_affinity.HAPPY, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("What's your favorite season?"),
            category=[_("Weather"), _("Nature")],
            player_says=True,
            affinity_range=(jn_affinity.NORMAL, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Do you have a sweet tooth?"),
            category=[_("Health"), _("Food")],
            player_says=True,
            affinity_range=(jn_affinity.DISTRESSED, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Do you drink alcohol?"),
            category=[_("Food"), _("Health")],
            player_says=True,
            affinity_range=(jn_affinity.NORMAL, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Sustainable fashion"),
            category=[_("Environment"), _("Fashion")],
            nat_says=True,
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can I give you a nickname?"),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Sleeping well"),
            conditional="persistent.jn_total_visit_count >= 5",
            category=[_("Health"), _("You")],
            nat_says=True,
            affinity_range=(jn_affinity.NORMAL, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Using headphones carefully"),
            category=[_("Health"), _("Music"), _("Technology")],
            nat_says=True,
            affinity_range=(jn_affinity.NORMAL, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Thoughts on horror"),
            category=[_("Media"), _("Literature")],
            nat_says=True,
            location="classroom"
        ),
        topic_group=TOPIC_TYPE_NORMAL
...
init python:
    registerTopic(
        Topic(
            ...
            label="talk_gaming",
            unlocked=True,
            prompt=_("Are you into video games?"),
            category=[_("Games"), _("Media")],
            player_says=True,
            location="classroom"
        ),
        topic_group=TOPIC_TYPE_NORMAL
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("I love you, {0}!").format(n_name),
            category=[_("Natsuki"), _("Romance")],
            player_says=True,
            location="classroom",
            affinity_range=(jn_affinity.ENAMORED, None)
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Why do you style your hair like that?"),
            category=[_("Fashion")],
            player_says=True,
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Having integrity"),
            category=[_("Society"), _("You")],
            nat_says=True,
            affinity_range=(jn_affinity.HAPPY, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("What's your favorite animal?"),
            category=[_("Animals"), _("Nature")],
            player_says=True,
            location="classroom"
        ),
        topic_group=TOPIC_TYPE_NORMAL
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("What's your favorite drink?"),
            category=[_("Food")],
            player_says=True,
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("What do you think of your school uniform?"),
            category=[_("Fashion")],
            player_says=True,
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            label="talk_flying",
            unlocked=True,
            prompt=_("Have you ever flown anywhere?"),
            category=[_("Transport")],
            player_says=True,
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("How do you feel about me?"),
            category=[_("Natsuki"), _("Romance"), _("You")],
            player_says=True,
            location="classroom"
        ),
        topic_group=TOPIC_TYPE_NORMAL
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Are you into cosplay?"),
            category=[_("Fashion"), _("Media"), _("Society")],
            player_says=True,
            location="classroom"
        ),
        topic_group=TOPIC_TYPE_NORMAL
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Fried squid"),
            category=[_("DDLC"), _("Food")],
            nat_says=True,
            affinity_range=(jn_affinity.HAPPY, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Do you have any collectibles?"),
            category=[_("Media")],
            player_says=True,
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Do you want to play Snap?"),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can you go over the rules of Snap again?"),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can you explain custom music for me again?"),
            category=[_("Music")],
...
init python:
    registerTopic(
        Topic(
            ...
            label="talk_vtubers",
            unlocked=True,
            prompt=_("Do you follow any VTubers?"),
            category=[_("Games"), _("Media"), _("Society")],
            player_says=True,
            location="classroom"
        ),
        topic_group=TOPIC_TYPE_NORMAL
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Are you into skateboarding?"),
            category=[_("Transport")],
            player_says=True,
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            label="talk_sports",
            unlocked=True,
            prompt=_("Do you play much sports?"),
            category=[_("Health")],
            player_says=True,
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Monika and the other girls"),
            conditional=(
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Leaving the space classroom"),
            conditional=(
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Are you afraid of lightning?"),
            category=[_("Fears"), _("Weather")],
            player_says=True,
            location="classroom"
        ),
        topic_group=TOPIC_TYPE_NORMAL
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("What do you think of Dan Salvato?"),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("How do you feel about Monika?"),
            category=[_("DDLC")],
            player_says=True,
            affinity_range=(jn_affinity.AFFECTIONATE, None),
            location="classroom"
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("How do you feel about Yuri?"),
            category=[_("DDLC")],
            player_says=True,
            affinity_range=(jn_affinity.AFFECTIONATE, None),
            location="classroom"
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("How do you feel about Sayori?"),
            category=[_("DDLC")],
            player_says=True,
            affinity_range=(jn_affinity.AFFECTIONATE, None),
            location="classroom"
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Do you drink much tea?"),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("How do I make friends?"),
            category=[_("Life"), _("Society"), _("You")],
            player_says=True,
            affinity_range=(jn_affinity.HAPPY, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can you do any impressions of the other girls?"),
            conditional="jn_utils.get_total_gameplay_length().total_seconds() / 3600 >= 48",
            category=[_("DDLC")],
            player_says=True,
            location="classroom"
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Newspapers and bias"),
            category=[_("Literature"), _("Media"), _("Society")],
            nat_says=True,
            affinity_range=(jn_affinity.HAPPY, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Are you afraid of flying?"),
            conditional="jn_utils.get_total_gameplay_days() >= 7",
            category=[_("Fears"), _("Transport")],
            player_says=True,
            location="classroom"
        ),
        topic_group=TOPIC_TYPE_NORMAL
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("What do you think about fanart?"),
            conditional="jn_utils.get_total_gameplay_days() >= 3",
            category=[_("Art"), _("Media")],
            player_says=True,
            location="classroom"
        ),
        topic_group=TOPIC_TYPE_NORMAL
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("How to interview properly"),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can you call me something else?"),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can I see a poem you've written for me?"),
            conditional=(
...
label talk_can_i_see_a_poem:
    ...
    if isinstance(_return, jn_poems.JNPoem):
        ...
        if Natsuki.isEnamored(higher=True):
            ...
            call show_poem (_return) from _call_show_poem_5
            ...
            call show_poem (_return) from _call_show_poem_6
            ...
            call show_poem (_return) from _call_show_poem_7
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("What sort of chocolate do you prefer?"),
            category=[_("Food")],
            player_says=True,
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Rage rooms"),
            category=[_("Entertainment"), _("Hobbies")],
            nat_says=True,
            affinity_range=(jn_affinity.HAPPY, None),
            location="classroom"
        ),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can you tidy away the decorations for me?"),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("What do you think about vegetarianism?"),
            conditional="jn_utils.get_total_gameplay_hours() >= 4",
            category=[_("Food"), _("Society")],
            player_says=True,
            location="classroom"
        ),
        topic_group=TOPIC_TYPE_NORMAL
...
label talk_daily_jokes_unlock:
    ...
    call talk_daily_joke (from_unlock=True) from _call_talk_daily_joke
...
label talk_daily_joke(from_unlock=False):
    ...
    call expression daily_joke.label from _call_expression_1
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can you start telling me daily jokes?"),
            category=[_("Jokes")],
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can you stop telling me daily jokes?"),
            category=[_("Jokes")],
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("What jokes have you told me before?"),
            category=[_("Jokes")],
...
label talk_daily_jokes_seen_before_start:
    ...
    call talk_daily_jokes_seen_before_loop from _call_talk_daily_jokes_seen_before_loop
...
label talk_daily_jokes_seen_before_loop:
    ...
    if isinstance(joke_choice, jn_jokes.JNJoke):
        ...
        call expression joke_choice.label from _call_expression_2
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("What's your favorite subject?"),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can you remind me next time you run out of topics?"),
            category=[_("Natsuki"), _("Reminders")],
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Playing things out loud"),
            category=[_("Wind-ups")],
            conditional="jn_utils.get_total_gameplay_hours() >= 4",
            nat_says=True,
            affinity_range=(jn_affinity.NORMAL, None),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Did you ever have any work experience?"),
            category=[_("Society")],
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Do you want to play Blackjack?"),
...
init python:
    registerTopic(
        Topic(
            ...
            unlocked=True,
            prompt=_("Can you go over the rules of Blackjack again?"),
