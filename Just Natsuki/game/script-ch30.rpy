...
label ch30_loop:
    ...
    while persistent._event_list:
        call call_next_topic from _call_call_next_topic
...
label call_next_topic(show_natsuki=True):
    ...
    if persistent._event_list:
        ...
        if renpy.has_label(_topic):
            ...
            if (persistent._jn_notify_conversations
                ...
                python:
                    ...
                    ENAMORED_NOTIFY_MESSAGES = [
                            ...
                            "¡Oye! ¿Tienes un segundo? [happy_emote]",
                            "¿Quieres hablar? [happy_emote]",
                            "¡[player]! ¡Tengo algo! [happy_emote]",
                            "¡Hoooola! ¿Quieres hablar?",
                            "¡Háblameeee! [angry_emote]",
                            "¡Te estoy hablando, tonto! [tease_emote]"
                        ]
                    AFFECTIONATE_NOTIFY_MESSAGES = [
                            "¿Quieres hablar?",
                            "¡[player]! ¿Quieres hablar?",
                            "¡Oye! ¡Oye! ¡Háblame! [angry_emote]",
                            "¡Oye, tonto! ¡Te estoy hablando!",
                            "¡[player]! ¡Acabo de pensar en algo! [confused_emote]",
            ...
            $ Natsuki.setInConversation(True)
            call expression _topic from _call_expression
...
label talk_menu:
    ...
    menu:
        n "[_talk_flavor_text]"
        "Let's talk about...":
            call player_select_topic from _call_player_select_topic
        "Tell me again about...":

            call player_select_topic (is_repeat_topics=True) from _call_player_select_topic_1
