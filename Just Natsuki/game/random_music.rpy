...
label random_music_change:
    ...
    $ track_quip = random.choice([
        _("¡Muy bien!{w=0.2} ¡Es hora de una melodía diferente!"),
        _("¡Ok!{w=0.2} ¡Es hora de otra canción!"),
        _("Sí,{w=0.2} creo que ya es suficiente de esta canción."),
        _("Está bien,{w=0.2} ya es suficiente."),
        _("Hora de una nueva canción."),
        _("¡Ya es suficiente con esta canción!"),
        _("Quiero escuchar algo más..."),
        _("¡Es hora de cambiar las cosas!")
    ])
    ...
    $ track_followup = random.choice([
        _("Ahora,{w=0.2} veamos..."),
        _("Ahora,{w=0.2} ¿qué tenemos?"),
        _("Veamos..."),
        _("¿Qué más tenemos...?"),
        _("¡Ajá!{w=0.5} ¡Probemos esto!"),
        _("Déjeme ver...")
    ])
